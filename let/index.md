...
<div class="card-menu">
    ...
    <!-- ICON: A proper bell curve, representing distribution and shape. -->
    ...
    <!-- Card 2: Study Design -->
    <!-- ICON: A document/clipboard, representing planning and methodical checks. -->
    ...
    <!-- ICON: A graph showing two distinct measurements, representing consistency. -->
    ...
    <!-- ICON: A table with a magnifying glass, representing interpretation and close reading. -->
