...
2.  In SPSS, click the **File** menu in the top-left.
3.  Select **Open**.
...
<a href="{{ "/spss/descriptives-frequencies/01-frequencies.html" | relative_url }}" class="btn btn-primary">Start Tutorial</a>
