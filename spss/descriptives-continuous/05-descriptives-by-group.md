...
*  From SPSS, go to **Analyze**, **Descripitve Statistics** then **Explore**
*  Place the `Age` variable into the **Dependent List** box
*  Place the `Sex` variable into the **Factor List** box
